...
CREATE TABLE IF NOT EXISTS `entry`.`school` (
  ...
  `goverment` VARCHAR(20) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `entry`.`question` (
  ...
  `question_type` ENUM('APTITUDE', 'DEPTH', 'CODING') NOT NULL DEFAULT 'APTITUDE',
  `body` VARCHAR(1023) NULL DEFAULT NULL,
